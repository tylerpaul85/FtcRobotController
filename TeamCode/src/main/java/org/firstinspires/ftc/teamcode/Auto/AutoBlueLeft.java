...
//            //going to 3rd box
            ...
            //moving back to wall
            strafeToPosition(-105.8, 0.8);
            //postioning to 2nd wobble
            moveToPosition(-25.2, 0.8);
            //grab wobble
            WobbleGrab();
            //lift arm
            WobbleArm(-10,0.5);
            //move to box
            strafeToPosition(108.2, 0.8);
            //move inside box
            moveToPosition(33.8, 0.8);
            // drop wobble
            WobbleUnGrab();
            //move out of box
            moveToPosition(-21.2, 0.8);
            //moving back
            strafeToPosition(-42.0, 0.8);
//            shoot rings
        }

        if (rings == 0) {
            strafeToPosition(60.4, 0.8);
            //
            moveToPosition(10, 0.8);

            strafeToPosition(-60.6, 0.8);
            //
            moveToPosition(-32.4, 0.8);
            //
            strafeToPosition(54.8, 0.8);
            //
            moveToPosition(32.4, 0.8);
            //
            moveToPosition(-32.4, 0.8);
            //
            strafeToPosition(11.2, 0.8);
        }


        if (rings == 1) {

            strafeToPosition(65.8, 0.6);
            //
            moveToPosition(11.8, 0.6);
            //
            strafeToPosition(18.6, 0.6);
            //
            sleep(2000);
            //
            strafeToPosition(-18.6, 0.6);
            ...
            sleep(2000);
            //
            strafeToPosition(78.0, 0.6);
            //
            moveToPosition(8.6, 0.6);
            //
            strafeToPosition(-13.0, 0.6);
        }
	//
    }
